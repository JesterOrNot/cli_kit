...
(function() {
  ...
  function initSearch(rawSearchIndex) {
    ...
    function initSearchNav() {
      ...
      search_input.onkeydown = function(e) {
        ...
        if (e.which === 38) {
          ...
          if (actives[currentTab].length) {
            document.location.href = actives[
              currentTab
    ...
    function makeTabHeader(tabNb, text, nbElems) {
      ...
      return (
        "<div>" + text + ' <div class="count">(' + nbElems + ")</div></div>"
      );
    }
  ...
  function autoCollapse(pageId, collapse) {
    if (collapse) {
      ...
      var blanket_list = document.getElementById(
  ...
  onEachLazy(
    document.getElementsByClassName("sub-variant"),
    buildToggleWrapper
  );
